...
output3 = a<10 and a%2==1 # bool: True if a is odd number less than 10

output4 =  a<10 and a%2==1 and a>-10 # bool: True if a is an odd number within the range -10 and 10

output5 = len(str(a))%2==0 and len(str(a))<=10  # bool: True if a has even number of digits but not more than 10 digits

is_offer1_cheaper = price1- ((price1/100)*discount1)< price2- ((price2/100)*discount2) # bool: True if the offer1 is strictly cheaper
