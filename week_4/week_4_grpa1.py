...
a_truthy_tuple = (1,2,3,4) # tuple: a tuple but when passed to bool function should return True
...
int_iterable_sorted_desc = list(sorted(int_iterable,reverse=True)) # list: the int_iterable sorted in desc order
...
if isinstance(some_collection,set): # some collections are not indexable why?
...
if isinstance(some_collection,set): # some collections are not slicable
